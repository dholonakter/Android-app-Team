...
//
//    public PeopleTab(ArrayList<Person> people) {
//        this.people = people;
//    }
//
//    @Override
...
//        adapter = new PeopleViewAdapter(getContext(), allPeopleNames);
...
//            allPeopleNames.add(people.get(i).getName());
//        }
//
//        adapter.setAllPeople(allPeopleNames);
